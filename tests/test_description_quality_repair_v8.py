...
from src.generate_description_quality_repair_v8 import (
    DESCRIPTION_REPAIRS,
    build_description_quality_repair_v8,
)


class DescriptionQualityRepairV8Tests(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_repairs_only_configured_descriptions(self) -> None:
        result, changed = build_description_quality_repair_v8(self.base)
    ...
    def test_repaired_descriptions_are_longer_specific_ascii_single_line(self) -> None:
        result, _ = build_description_quality_repair_v8(self.base)
        ...
        for prop in DESCRIPTION_REPAIRS:
            ...
            self.assertGreater(len(after), len(str(before)) + 80)
